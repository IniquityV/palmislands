...
import me.vickrum.island.gui.configuration.*;
import me.vickrum.island.gui.types.*;
...
public abstract class BaseGui {
	...
	protected void loadGui() {
		if (this.inventory == null) {
			MixinMessage.get().msgOne(this.player, MConf.get().msgGuiNameNotSet);
			return;
		}
	...
	public void buildGui() {
		if (this.guiDesign == null) {
			if (this.player != null)
				MixinMessage.get().msgOne(this.player, MConf.get().msgGuiDesignNotSet);
			return;
		}
