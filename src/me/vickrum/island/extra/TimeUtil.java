...
public class TimeUtil {
	...
	public static String formatTime5(long timePeriod) {
		String output = "";
	...
	public static String formatTime5(int seconds) {
	...
	public static String formatPlayTime1(long playTime) {
	...
	public static String getTimeString() {
		...
		return time > 12 ? time - 12 + ":" + (minutes < 10 ? "0" + minutes : minutes) + "PM"
				: time + ":" + (minutes < 10 ? "0" + minutes : minutes) + "AM";
	}
	...
	public static String getTimeStringSeconds() {
		...
		return time > 12
				? time - 12 + ":" + (minutes < 10 ? "0" + minutes : minutes) + ":"
