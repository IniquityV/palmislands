...
public class ContainerGameProfile {
	...
	public String getUuid() {
		return DataItemStack.get(this.uuid, UUID_DEFAULT);
	}

	public void setUuid(String uuid) {
		this.uuid = DataItemStack.set(uuid, UUID_DEFAULT);
	}

	private String name = null;

	public String getName() {
		return DataItemStack.get(this.name, NAME_DEFAULT);
	}

	public void setName(String name) {
		this.name = DataItemStack.set(name, NAME_DEFAULT);
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof ContainerGameProfile))
			return false;
		ContainerGameProfile that = (ContainerGameProfile) object;

		return MUtil.equals(this.getUuid(), that.getUuid(), this.getName(), that.getName(),
